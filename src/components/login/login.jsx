...
export default function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await apiRequest("http://localhost:3001/auth/login/", {
      method: "POST",
      body: formData,
    });
    console.log(data);
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Email"
                className="pl-10 w-full border b0order-gray-300 focus:border-gray-300 rounded-lg py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue"
                required
              />
            </div>
          </div>
